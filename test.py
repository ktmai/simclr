...
#                                        transform = standard_transform)
    ...
    trainset = CIFAR10_TANDA(root="/home/amavorpa/simclr/batches/train/")

    valset = CIFAR10_TANDA(root="/home/amavorpa/simclr/batches/validation/")
    ...
    for epoch in range(args.EPOCHS):
        ...
        test(args, test_saved_model, device, val_loader)
