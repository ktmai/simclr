...
class CIFAR10_new(VisionDataset):
    ...
    def __getitem__(self, index):
        ...
        img1, T1 = self.apply_transformations(img1)
        img2, T2 = self.apply_transformations(img2)

        if self.target_transform is not None:
            target = self.target_transform(target)

        return img1, img2, target, T1, T2
    ...
    def define_transformations(self):
        ...
        self.color_distort = get_color_distortion(s=0.5)
